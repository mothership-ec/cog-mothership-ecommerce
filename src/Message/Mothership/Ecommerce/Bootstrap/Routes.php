...
class Routes implements RoutesInterface
{
	public function registerRoutes($router)
	{
		...
		$router['ms.ecom.checkout']->add('ms.ecom.checkout.details.addresses.action', '/details/addresses/action', '::Controller:Checkout:Details#addressProcess')
			->setMethod('POST');
		...
		$router['ms.ecom.checkout']->add('ms.ecom.checkout.payment.successful', '/payment/successful/{orderID}/{hash}', '::Controller:Checkout:Payment#successful')
			->setRequirement('orderID', '\d+');
